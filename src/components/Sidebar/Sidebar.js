...
function Sidebar() {
  ...
  return (
    <>
      {/* Need to style button with theme. */}
      ...
      {/* Need to style text and links, maybe add a background image? */}
      ...
      <Offcanvas show={show} onHide={handleClose}>
        ...
        <Offcanvas.Body>
          <div>
            <p>
              Couldn’t find what you’re looking for? Follow the links below to
              learn more about me and my work!
            </p>
            {data.map(({ id, url, profile }) => (
              <ul key={id} className="profileLinks">
                <li>
